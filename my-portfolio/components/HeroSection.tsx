    ...
    >
      ...
      >
        ...
        >
          ...
          <Link
            href="/projects"
            className="relative border border-white/20 bg-white/5 backdrop-blur-sm px-8 py-3 rounded-full text-xs uppercase tracking-widest text-white hover:bg-white/10 transition-all duration-300 inline-block"
          >
            View My Work
          </Link>
        </motion.div>
