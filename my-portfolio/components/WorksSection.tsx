  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        {/* Section Heading */}
        <RevealOnScroll>
          <h2 className="font-serif text-5xl md:text-7xl text-center mb-20">
            ...
            <div className="bg-card border border-white/10 rounded-3xl p-8 md:p-12 aspect-[4/5] flex flex-col justify-between hover:border-accent/50 transition-colors duration-500">
              ...
              <div className="flex items-start justify-between">
                ...
                >
                  <iconify-icon
                    icon="ph:arrow-up-right-bold"
                    className="text-white text-xl -rotate-45 group-hover:rotate-0 transition-transform duration-500"
                  />
                </Link>
        ...
        <RevealOnScroll delay={0.2}>
          <div className="mt-16 grid md:grid-cols-3 gap-6">
            {[
              ...
              <Link
                key={project.title}
                href={index === 0 ? '/projects/devhub-dashboard' : '/projects/containerized-api-service'}
