    ...
    <section className="pt-40 pb-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="mt-6 text-lg text-gray-400 max-w-2xl">
          Drop a PDF at <span className="text-white">/public/resume.pdf</span> to enable download.
        </p>
          ...
          <div className="bg-card border border-white/10 rounded-3xl p-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-gray-400">Add your PDF and this link will work immediately.</p>
              </div>
              <a
